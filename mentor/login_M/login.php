...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $query    = "SELECT * FROM `mentors` WHERE username='$username'
        ...
        if ($rows == 1) {
            ...
            // Set username and mentor_id in session variables
            ...
            // Displaying an error message using JavaScript
...
<body>
      <div class="login">
        ...
        <form method="post" name="login" class="login__form">
          <h1 class="login__title">Mentor login</h1>
          ...
          <button type="submit" value="Login" name="submit" class="login__button">Login</button>
